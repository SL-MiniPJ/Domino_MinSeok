...
(function(){
	...
	function _trk_callTracker(a1,b1){
		...
		var _tcts_code_skp="https://idm.skplanet.com/pixel?nid=10&uid="+_TRK_DPUID+"&url="+_skp_return_url;
		...
		window["_tcts_img_app_"+_TRK_LAID+_TRK_CTS]=new Image();
            ...
            if(_TRK_CQ.indexOf("BSPRG")>0||_TRK_CQ.indexOf(_TRK_CTSP)>0||((typeof _TRK_PI)!="undefined"&&_TRK_PI!="")||
                ...
                if(_trk_bJS12==true){
                	if(typeof _TRK_DPUID!="undefined"&&_TRK_DPUID!=""){
						...
						//2017.11.08. k3363. About DMP For SKP
						//2018.05.08. k3363. About DMP For APPIER
						if(isBSFlag == null || isBSFlag == "") {
							try{
								...
								setTimeout(function(){window["_tcts_img_app_"+_TRK_LAID+_TRK_CTS].src=_trk_code_app;},10);
                    ...
                    if(typeof _TRK_DPUID!="undefined"&&_TRK_DPUID!=""){
						...
						//2017.11.08. k3363. About DMP For SKP
						//2017.11.08. k3363. About DMP For APPIER
						if(isBSFlag == null || isBSFlag == "") {
							try{
