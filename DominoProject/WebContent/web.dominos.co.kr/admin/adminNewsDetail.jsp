		...
		<div id="container">
    		...
    		<div align="center">
    			...
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
    				...
    				<tr align="left" style="border-bottom: 2px solid black; cellspacing="10px">
    					<td>
    						<% if(bean.getAdd_file() != null) {%>
    							<div style="padding: 20px">
    								<img src="../../newsupload/<%=bean.getAdd_file() %> ">
    							</div>
    						<%}%>
    						<%=bean.getBulletin() %>	
    					</td>
    				...
    				<tr align="center" valign="middle">
      					<td>
         					<a href="./AdminNewsDeleteAction.bo?list_num=<%=bean.getList_num()%>">[삭제]</a>&nbsp;&nbsp;
