...
ul.menu:after {
	...
	clear: both;
			...
			<section id="content">
				<div class="myinfo-wrap">
					<div class="form">
						...
						<form name="storeAddForm" id="storeAddForm"
							action="./AdminStoreAddAction.st" method="post">
							<dl>
								<dt class="center">매장이름</dt>
								<dd>
									<div class="form-item name">
										<input type="text" id="inputStoreName" name="inputStoreName"
											placeholder="매장 이름" style="width: 200px">
									</div>
								</dd>
							</dl>
							<dl>
									...
									<div class="form-group v2">
										<div class="form-item">
											<input type="text" name="tel1" id="tel1" maxlength="4"
												title="매장전화번호"> <input type="text" name="tel2"
												id="tel2" maxlength="4" title="매장전화번호"> <input
								...
								<dd>
									<div class="form-item name">
										<input type="text" id="inputStorePark" name="inputStorePark"
											placeholder="ex)주차가능" style="width: 200px">
									</div>
								</dd>
							</dl>
							<dl>
								...
								<dd>
									<div class="form-item name">
										<input type="text" id="inputStoreOther" name="inputStoreOther"
											placeholder="ex)단체석 완비" style="width: 200px">
									</div>
								</dd>
							</dl>
							<dl>
								...
								<dd>
									<div class="form-item name">
										<input type="text" id="inputStoreSale" name="inputStoreSale"
											placeholder="ex)30" style="width: 100px"> % 할인
									</div>
								</dd>
							</dl>
						</form>
				...
				<div class="btn-wrap">
					<a href="javaScript: addStore()" class="btn-type v6" style="margin-bottom: 100px">매장 등록</a>
				</div>
			</section>
		</div>
		...
		<script>
			function addStore() {
				var storeAddForm = document.getElementById("storeAddForm");
				storeAddForm.submit();
			}
		</script>
