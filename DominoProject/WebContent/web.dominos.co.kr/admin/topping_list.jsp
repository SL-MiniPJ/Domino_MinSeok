...
%>
			<tr>
				...
				<td></td>
				<td></td>
				<td><a href="../../topping_image/<%=product.getTopping_image() %>"><%=product.getTopping_image() %></a></td>
				<td><a href="./ToppingDeleteAction.pro?topping=<%=product.getTopping() %>">토핑 삭제</a></td>
			</tr>
<%
	}
%>
