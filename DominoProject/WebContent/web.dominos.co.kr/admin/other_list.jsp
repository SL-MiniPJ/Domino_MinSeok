	...
	height: 30px;
				...
				<div align="center">
					...
					<table border=1 style="border-collapse: collapse;">
						...
						%>
						<tr>
							<td><%=product.getOther_code()%></td>
							<td><%=product.getOther_name()%></td>
							<td><%=product.getOther_price()%></td>
							<td></td>
							<td></td>
							<td></td>
							...
							<td><a href="../../other_image/<%=product.getOther_image()%>"><%=product.getOther_image()%></a></td>
							<td><a
								href="./OtherDeleteAction.pro?other_code=<%=product.getOther_code()%>">음료/기타
									삭제</a></td>
						</tr>
						<%
							}
