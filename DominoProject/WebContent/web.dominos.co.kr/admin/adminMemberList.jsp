    	...
    	<section id="content">
    		...
    		<div id="store_list" align="center">
	    		...
	    		<table style="margin-bottom: 30px">
					...
					<tr>
						<td><%=bean.getMember_code() %></td>
						<td><%=bean.getMember_id() %></td>
						<td><input type="button" value="상세정보" 
								onclick=<%out.print("\"location.href='AdminMemberDetail.me?member_id=" + bean.getMember_id() +"'\""); %>/></td>
						<td><input type="button" value="삭제" 
								onclick=<%out.print("\"location.href='AdminMemberDelete.me?member_id=" + bean.getMember_id() +"'\""); %>/></td>
					<tr>
					<%}%>
					
					<tr>
						<td>총회원수</td>
						<td colspan="3"><%=membercount %></td>
					</tr>
				</table>
    		</div>
    	</section>
