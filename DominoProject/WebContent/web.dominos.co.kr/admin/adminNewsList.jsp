...
ul.menu:after {
	...
	clear: both;
		...
		<div id="container">
    		...
    		<div align="center">
    			<h1 class="page-title" style="font-size: 36px; width: 80%; text-align: left; padding: 50px">도미노 뉴스</h1>
    			<hr/ style="width: 80%; border-left-width: thick;">
    			
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
					<tr align="center" valign="middle" style="border-bottom: 2px solid black">
						<td style="width: 10p%"></td>
						<td align=right style="width: 90%">
							<font size=2>글 개수 : <%=listcount %></font>
						</td>
					</tr>
	
					<tr align="center" valign="middle" bordercolor="#333333" style="border-bottom: 1px solid gray;">
						<td id="num" style="font-family:Tahoma;font-size:8pt;" height="26">
							<div align="center">번호</div>
						</td>
						<td id="title" style="font-family:Tahoma;font-size:8pt">
					...
					<%
						for(int i=0;i<newslist.size();i++){
							NewsBean bean=(NewsBean)newslist.get(i);
					%>
						<tr align="center" valign="middle" bordercolor="#333333"
							onmouseover="this.style.backgroundColor='F8F8F8'"
							onmouseout="this.style.backgroundColor=''" style="border-bottom: 1px solid gray;">
							<td height="23" style="font-family:Tahoma;font-size:10pt;" >
								<b><%=bean.getList_num()%></b>
							</td>
		
							<td style="font-family:Tahoma;font-size:10pt;">
								<div align="left">
									<a href="./AdminNewsDetail.bo?num=<%=bean.getList_num()%>">
										<b> ▶ <%=bean.getTitle()%></b>
									</a>
								</div>
							</td>
					...
					<tr align="right" style="border-top: 2px solid black;">
						<td></td>
						<td>
	   						<a href="./AdminNewsWriteView.bo">[글쓰기]</a>
						</td>
					</tr>
				</table>
			</div>
