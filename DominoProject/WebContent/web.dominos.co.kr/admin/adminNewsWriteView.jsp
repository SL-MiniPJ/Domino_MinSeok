	...
	clear: both;
		...
		<div id="container">
    		...
    		<div align="center">
    			...
    			<form action="./AdminNewsWriteAction.bo" method="post"
    				enctype="multipart/form-data" name="newsform" id="newsform">
    				
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
					<tr>
						<td style="font-family:돋음; font-size:12; width: 10%">
							<div align="center">제 목</div>
						</td>
						<td style="width: 90%">
							<input name="news_title" type="text" size="50" maxlength="100" value=""/>
						</td>
					</tr>
					<tr>
						<td style="font-family:돋음; font-size:12; height: 500px">
							<div align="center">내 용</div>
						</td>
						<td>
							<textarea name="news_bulletin" cols="67" rows="30" style="height: 500px"></textarea>
						</td>
					</tr>
					<tr>
      					<td style="font-family:돋음; font-size:12">
         					<div align="center">사진 첨부</div>
      					</td>
      					<td>
         					<input name="news_file" type="file"/>
      					</td>
   					</tr>
					<tr align="center" valign="middle">
      					<td colspan="2">
         					<a href="javascript:addnews()">[등록]</a>&nbsp;&nbsp;
