	...
	<div id="container">
    	<section id="content">
    		...
    		<div id="member_info" align="center">
    			...
    			<h1 class="page-title" style="font-size: 36px; padding: 50px;">개인 정보</h1>
    		...
    		<div class="btn-wrap">
				<a href="./MemberModifyForm.me?loginId=<%=bean.getMember_id() %>" class="btn-type v6" style="margin-bottom: 100px">정보 수정</a>
			</div>
    	</section>
	</div>
