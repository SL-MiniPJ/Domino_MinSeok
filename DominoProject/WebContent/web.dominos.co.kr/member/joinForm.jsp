            ...
            <div class="inner-box">
                ...
                <article class="join-area">
                    ...
                    <div class = "myinfo-wrap">
                    	<div class="form">
                    	<%request.setCharacterEncoding("UTF-8"); %>
                    		<form name="frm" id="frm" action="./JoinAction.me" method="post">
                    			<dl>
                    				<dt class="center">이름</dt>
                    				<dd>
                    					<div class="form-item name">
                    						<input type="text" id="inputName" name="inputName" placeholder="이름" style="width:200px">
                    					</div>
                    				</dd>
                    			</dl>
                    			<dl>
                    				...
                    				<dd>
                    					<div class="form-item name">
                    						<input type="text" name="inputId" id="inputId" maxlength="16" style="width:200px">
                    						<a href="javascript:idCheck('inputId')" class="btn-type v7">중복확인</a>
                    					</div>
                    			...
                    			<dl>
                    				...
                    				<dd class="mb">
                    					<div class="form-item number">
                    						<input type="password" name="inputPw" id="inputPw" maxlength="16"
                    			...
                    			<dl>
                    				...
                    				<dd class="mb">
                    					<div class="form-item number">
                    						<input type="password" name="inputPwchk" id="inputPwchk" maxlength="16"
                    						placeholder="비밀번호" style="width:200px">
                    					</div>
                    					<div class="text-type4" id="passwd_alert" style="display:none;"></div>
                    				</dd>
                    			...
                    			<dl>
                    				...
                    				<dd>
                    					<div class="form-item birth">
                    							<input type="text" id="byear" name="byear" class="selected" style="width:100px">년
                    							<input type="text" id="bmonth" name="bmonth" class="selected" style="width:100px">월
                    							<input type="text" id="bday" name="bday" class="selected" style="width:100px">일
                    					</div>
                    			</dl>
                    			<dl>
                    				...
                    				<dd>
                    					<div class="form-group v2">
                    						<div class="form-item">
                    							<input type="text" name="tel1" id="tel1" maxlength="4" title="휴대전화번호">
                    							<input type="text" name="tel2" id="tel2" maxlength="4" title="휴대전화번호">
                    							<input type="text" name="tel3" id="tel3" maxlength="4" title="휴대전화번호">
                    						</div>
                    					</div>
                    				</dd>
                    			</dl>
                    			<dl>
                    				...
                    				<dd>
                    					<div calss="form-group v2">
                    						...
                    						<div class="text-type4" id="email_alert" style="dispplay:none;"></div>
                    					</div>
                    				</dd>
                    			</dl>
                    			<dl>        				
                    				...
                    				<dd>
                    					<div class="form-group v2">
                    						<div class="form-item address">
                    							...
                    							<a href="javaScript:sample4_execDaumPostcode();" class="btn-type v7">우편번호찾기</a> <br>
                    						</div>
                    					</div>
                    				</dd>
                    				...
                    				<dd>
                    					<div class="form-group v2">
                    						<div class="form-item address">
                 								<input type="text" id="sample4_roadAddress" placeholder="도로명주소" name="sample4_roadAddress" style="width:200px">
                  								<input type="text" id="sample4_jibunAddress" placeholder="지번주소" name="sample4_jibunAddress" style="width:200px">
                    						</div>
                    					</div>
                    				</dd>
                    				...
                    				<dd>
                    					<div class="form-group v2">
                    						<div class="form-item address">
                  								<input type="text" id="sample4_detailAddress" placeholder="상세주소" name="sample4_detailAddress" style="width:200px">
                  								<input type="text" id="sample4_extraAddress" placeholder="참고항목" name="sample4_extraAddress" style="width:200px">
                    						</div>
                    					</div>
                    				</dd>
                    			</dl>
                    ...
                    <div class="btn-wrap">
                    	<a href="javaScript:_check()" class="btn-type v6">가입하기</a>
                    </div>
