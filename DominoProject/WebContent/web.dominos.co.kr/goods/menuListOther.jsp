...
<!-- Mirrored from web.dominos.co.kr/goods/list?dsp_ctgr=C0202 by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Sep 2020 11:22:20 GMT -->
<!-- Added by HTTrack -->
...
<meta http-equiv='Cache-Control' content='no-cache'>
<!-- 사용자지정 태그 -->
<meta name="description" content="도미노피자와 함께 즐기는 다양한 음료" />
<meta name="title" content="음료- 도미노피자" />
<title>음료- 도미노피자</title>
<meta property="og:type" content="website" />
<meta property="og:title" content="음료- 도미노피자" />
<meta property="og:site_name" content="도미노피자" />
<meta property="og:image"
	content="../../cdn.dominos.co.kr/renewal2018/w/img/sns_pre.png" />
<meta property="og:image:width" content="270" />
<meta property="og:image:height" content="270" />
<meta property="og:description" content="도미노피자와 함께 즐기는 다양한 음료" />
<meta property="og:url" content="/goods/list" />
<meta name="twitter:card" content="app" />
<meta name="twitter:title" content="음료- 도미노피자" />
<meta name="twitter:image"
	content="../../cdn.dominos.co.kr/renewal2018/w/img/sns_pre.png" />
<meta name="twitter:description" content="도미노피자와 함께 즐기는 다양한 음료" />
	...
	<div id="wrap">
		...
		<script>
			...
			var addGoods = function(goodsCode) {
				...
				var returnUrl = "listc6d6.html?dsp_ctgr=C0202";
			...
			<section id="content">
				<div class="sub-type menu">
					<div class="inner-box">
						...
						<article class="menu-list-area">
							...
							<div class="menu-nav-wrap">
								<div class="menu-nav">
									<ul>
										<li><a href="./MenuListPizza.pro">피자</a></li>
										<li><a href="./MenuListSide.pro">사이드디시</a></li>
										<li class="active"><a href="./MenuListOther.pro">음료&기타</a></li>
									</ul>
								</div>
					...
					<div class="menu-list">
							...
							List otherList = productdao.getOtherList();
							%>
							<ul>
								<!-- 피자&사이드 -->
								<%
									for (int i = 0; i < otherList.size(); i++) {
									bean = (ProductBean) otherList.get(i);
								%>
								<li>
									<div class="prd-img">
										<img class="lazyload"
											src="../../other_image/<%=bean.getOther_image() %>"
											alt="<%=bean.getOther_image() %>" />
									</div>

									<div class="prd-cont type2">
										<div class="subject"><%=bean.getOther_name() %></div>
									</div>

									<div class="prd-price">
										<div class="price-box">
											<span class="price"><%=bean.getOther_price() %>원</span>
										</div>
									</div>
								...
								<dd>
									<ul>
										<li>단종으로 인한 상품권 사용 안내 : 동일 가격 또는 더 높은 가격의 제품으로 대체 주문 가능<br>
											(상품권에 명시된 제품보다 더 높은 가격대의 제품 주문 시, 금액 추가 발생)<br> (단, 상품권에
											명시된 제품보다 저렴한 제품 주문 시 발생하는 차액에 대해서는 환불 처리 불가)
										</li>
		...
		function getDetail(code_01, dsp_ctgr, dough_gb) {
			...
			$.ajax({
				...
				success : function(data) {
					...
					$(".btn_order a").attr(
							"href",
							"detail?dsp_ctgr=" + dsp_ctgr + "&code_01="
									+ code_01 + "&dough_gb=" + dough_gb);
							...
							<div class="step-wrap step-cont">
								...
								<div class="js_toggle_box close">
									...
									산미, 감칠맛이 극상의 조화를 이루기 때문에 피자 맛에 깊이를 더합니다.<br /> <br /> <strong>항상
										놀랍고 새로운 프리미엄 토핑!</strong> 도미노피자는 프리미엄 피자에 어울리는 최고급 식자재인 와규, 직화스테이크, 게살,
									블랙타이거 슈림프 등 항상 놀라움과 새로움을 주는 혁신적인 프리미엄 토핑을 피자 업계 최초로 적용하며 소비자의
									입맛과 트렌드를 선도하고 피자 선택의 폭을 넓히는 것은 물론 도미노피자만의 색다른 고객 감동을 만들어 가고
									있습니다.
								</div>
							</div>
						</div>
