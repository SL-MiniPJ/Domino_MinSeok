					...
					<div class="inner-box">
						...
						<article class="menu-list-area">
							...
							<div class="menu-list">
								...
								List sideList = productdao.getSideList();
								%>
								<ul>
									<!-- 피자&사이드 -->
									<%
										for (int i = 0; i < sideList.size(); i++) {
											bean = (ProductBean)sideList.get(i);
									%>
									<li>
										<div class="prd-img">
											<a
												href="SideDetail.pro?side_code=<%=bean.getSide_code()%>">

												<img class="lazyload"
												src="../../pizza_image/<%=bean.getSide_image() %>"
												alt="<%=bean.getSide_image() %>" />
											</a>
										</div>
										<div class="prd-cont">
											<div class="subject">
										...
										<div class="prd-price">
											<div class="price-box">
												<span class="price"><%=(int)bean.getPizza_price()%>원</span>
											</div>
										</div>
									</li>
									<%
